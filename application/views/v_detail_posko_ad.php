...
<form class="form-horizontal form-material" action="<?= base_url('detail_posko_ad/edit_detail'); ?>" method="post">
            <div class="row">
                                 ...
                                 <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <a href="<?php echo base_url('admin_kd'); ?>" class="btn btn-info float-right mr-4 mb-5">Back</a>
        </form>
